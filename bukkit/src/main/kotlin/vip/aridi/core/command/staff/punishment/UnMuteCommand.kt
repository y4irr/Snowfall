...
class UnMuteCommand {
    ...
    fun pardon(
        ...
        val findLastPunishment = punishmentModule.findLastPunishmentByType(player.uniqueId, PunishmentType.MUTE)

        if (findLastPunishment == null) {
            sender.sendMessage(CC.translate("&cThis player is not muted."))
            return
        }
